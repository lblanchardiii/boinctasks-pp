...
public:
    ...
    double cpu_short_term_debt= 0;
    double cpu_long_term_debt=0;
    double cpu_backoff_time;
    double cpu_backoff_interval;
    double cuda_debt=0;
    double cuda_short_term_debt=0;
    double cuda_backoff_time=0;
    double cuda_backoff_interval;
    double ati_debt=0;
    double ati_short_term_debt=0;
...
public:
   ...
   // int set_cc_config_v6(CONFIG_V6& config, LOG_FLAGS_V6& log_flags);
    ...
    int get_cc_config_raw(CC_CONFIG& config, LOG_FLAGS& log_flags, std::string& result_string);
